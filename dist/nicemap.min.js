"use strict";function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),a}var dd,NicemapGeoJson=/*#__PURE__*/function(){function a(b){if(_classCallCheck(this,a),b=b||{},!b.url)throw"Missing parameter 'url'";this.url=b.url,this.countryName=b.countryName||"MAPLAB",this.countryCode=b.countryCode||"ISO3CD",this.scaleFactor=b.scaleFactor||1,this.offset=b.offset||[0,-.25]}return _createClass(a,[{key:"fetch",value:function(a){function b(){return a.apply(this,arguments)}return b.toString=function(){return a.toString()},b}(function(){if(void 0===this.result){console.log("fetching "+this.url);var a=this;this.result=fetch(this.url).then(function(a){return a.json()}).then(function(b){return a._processResult(b)})["catch"](function(b){return console.error(b),a.result=Promise.resolve(null)})}return this.result})},{key:"_processResult",value:function _processResult(a){if(dd=a,"object"!=_typeof(a)||"FeatureCollection"!=a.type)throw"Invalid map data : "+this.url;var b=this;return a.features=a.features.filter(function(a){return"ATA"!=a.properties.ISO3CD}),a.features.forEach(function(a){a._nicemapCountryName=a.properties[b.countryName],a._nicemapCountryCode=a.properties[b.countryCode]}),this.result=Promise.resolve(a),this.result}}]),a}(),Nicemap=/*#__PURE__*/function(){// options:
...
this.svg=d3.select(d).append("svg").attr("class","nicemap-svg").call(e).on("dblclick.zoom",null);var f=this.mapG=this.svg.append("g");this.projection=d3.geoMercator(),this.boundaryColor="#bbb",this.processData(b.data),this.createLegend(),this.createTooltip(),this.createZoomButtons(),this.mapScaleFactor=b.mapData.scaleFactor,this.mapOffset=b.mapData.offset;var g=this;b.mapData.fetch().then(function(a){return g.worldMap=a}).then(function(){return g.redraw()}),window.addEventListener("resize",function(){return g.redraw()})}return _createClass(a,[{key:"redraw",value:function redraw(){var a=Math.PI,b=this.container,c=b.clientWidth,d=b.clientHeight,e=this.projection,f=.5*c;e.scale(this.mapScaleFactor*c/(2*a)).translate([.5*c+f*this.mapOffset[0],.5*d-f*this.mapOffset[1]]),this.svg.attr("width",c).attr("height",d);var h=d3.geoPath().projection(e),i=this.mapG,g=this.worldMap.features,j=this,k=i.selectAll("path").data(g);k.exit().remove(),k.enter().append("path").style("stroke",j.boundaryColor).style("vector-effect","non-scaling-stroke").merge(k).attr("d",h).style("fill",function(a){return j.getValueColor(a._nicemapCountryCode)})// handle tooltip
.on("mouseover",function(a){this.parentNode.appendChild(this),d3.select(this).style("stroke","black"),j.showTooltip(a)}).on("mousemove",function(a){j.showTooltip(a)}).on("mouseout",function(){d3.select(this).style("stroke",j.boundaryColor),j.hideToolTip()});this.legend.attr("visibility","visible").attr("transform","translate(10, "+(d-40)+")"),this.zoom.translateExtent([[0,0],[c,d]]).extent([[0,0],[c,d]])}// compute value range and build the color scale
